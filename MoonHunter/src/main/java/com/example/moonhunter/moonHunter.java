...
public class moonHunter extends Application {
    ...
    //    ImageView blackScreen = new ImageView("https://upload.wikimedia.org/wikipedia/commons/c/c8/Very_Black_screen.jpg");
    ...
    public class Moon extends Pane {
        ...
        private void moveBall() {
            ...
            if (body.getY() > 820 || totalCount == 30) /* if the moon touched the border */ {
        ...
        private void moveBall1() {
            ...
            if (body1.getY() > 830 || totalCount == 30) /* if the moon touched the border */ {
                // set the Y to the start
                body.setVisible(false);
                body1.setVisible(false);
                body2.setVisible(false);
        ...
        private void moveBall2() {
            ...
            if (body2.getY() > 840 || totalCount == 30) /* if the moon touched the border */ {
                // set the Y to the start
                body.setVisible(false);
                body1.setVisible(false);
                body2.setVisible(false);
        ...
        private void moveBall3() {
            ...
            if (body3.getY() > 850 || totalCount == 30) /* if the moon touched the border */ {
                // set the Y to the start
                body.setVisible(false);
                body1.setVisible(false);
                body2.setVisible(false);
        ...
        private void moveBall4() {
            ...
            if (body4.getY() > 860 || totalCount == 30) /* if the moon touched the border */ {
                // set the Y to the start
                body.setVisible(false);
                body1.setVisible(false);
                body2.setVisible(false);
